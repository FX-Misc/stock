...
def get_stockdata(code,sy,sm,sd,ey,em,ed,tm):
  ...
  while(plen>=20):
    ...
    ss=ss+ret
    p=p+1
  f=open("/mnt/stock/data/hist/weekly/"+code+".txt","w")
  #f=open(code+".txt","w")
  f.write(ss)
  f.close()
...
if __name__ == '__main__':
  #get_stockdata_all("2001","01","01","2016","12","31","w")
  #get_stockdata("998407","2001","01","01","2016","12","31","w")
  #get_stockdata("998405","2001","01","01","2016","12","31","w")
  #get_stockdata("23337","2001","01","01","2016","12","31","w")
  get_stockdata("9997","2001","01","01","2016","12","31","w")
  #for code in range(1301,1321):
  #  get_stockdata(str(code),"2001","01","01","2016","12","31","w")
